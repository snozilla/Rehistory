    ...
    <div className="flex min-h-[calc(100vh-3.5rem)] flex-col items-center justify-center py-16">
      <div className="w-full max-w-2xl space-y-10">
        ...
        <div className="text-center space-y-4">
          <div className="inline-flex items-center gap-2 rounded-full border border-amber-500/20 bg-amber-500/5 px-4 py-1.5 text-sm text-amber-600 dark:text-amber-400">
            <GitBranch size={14} />
        ...
        {mounted && !apiKey && (
          <div className="flex items-start gap-3 rounded-xl border border-amber-500/20 bg-amber-500/5 px-4 py-3">
            ...
            <div>
              <p className="text-sm text-amber-700 dark:text-amber-200">API key required</p>
              <p className="text-xs text-amber-600/70 dark:text-amber-400/70 mt-0.5">
                Configure your {provider === "openai" ? "OpenAI" : "Anthropic"} API key in{" "}
                <a href="/settings" className="underline hover:text-amber-500 dark:hover:text-amber-300">
                  Settings
                </a>{" "}
